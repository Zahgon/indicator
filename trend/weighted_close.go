...
func NewWeightedClose[T helper.Number]() *WeightedClose[T] { _ = "STUB: not implemented"; return nil }
...
func (*WeightedClose[T]) String() string { _ = "STUB: not implemented"; return "" }
