...
func NewCfo[T helper.Number]() *Cfo[T] { _ = "STUB: not implemented"; return nil }

// NewCfoWithPeriod function initializes a new CFO instance with the given period.
func NewCfoWithPeriod[T helper.Number](period int) *Cfo[T] { _ = "STUB: not implemented"; return nil }

// Compute function takes a channel of numbers and computes the CFO.
func (c *Cfo[T]) Compute(closing <-chan T) <-chan T { _ = "STUB: not implemented"; return nil }

// IdlePeriod is the initial period that CFO won't yield any results.
func (c *Cfo[T]) IdlePeriod() int { _ = "STUB: not implemented"; return 0 }
